...
export const PARTNER_IDS = {
  VLAD: 'partner_vlad',
  NIKITA: 'partner_nikita',
} as const;

export const INITIAL_PARTNERS_SEED: readonly Partner[] = [
  {
    id: PARTNER_IDS.VLAD,
    name: 'Влад',
    isActive: true,
...
export const ACCOUNT_IDS = {
  CASH_1: 'cash_1',     // Нал 1 (Касса на площадке / Нал_Тиньков)
...
export const CATEGORY_IDS = {
  ...
  // Expense categories (general bar & business overhead)
  OVERHEAD: 'overhead',
  INVENTORY: 'inventory',
  TAXES: 'taxes',
  ACCOUNTING: 'accounting',
  // Partner / Dividends categories
  DIVIDENDS: 'dividends',
...
export const INITIAL_CATEGORIES_SEED: readonly Category[] = [
  ...
  {
    id: CATEGORY_IDS.STAFF_MEALS,
    name: 'Стафпитание (обеды, кофе)',
    type: 'expense',
  ...
  },
  {
    ...
    name: 'Транспорт и платные дороги',
    type: 'expense',
    direction: 'operational',
    color: '#3b82f6', // Blue
    icon: 'car',
  ...
  {
    id: CATEGORY_IDS.DIVIDENDS,
    name: 'Дивиденды партнёрам',
    type: 'expense',
    direction: 'dividends',
    color: '#8b5cf6', // Purple
    icon: 'user-check',
  ...
  {
    id: CATEGORY_IDS.PERSONAL_WITHDRAWAL,
    name: 'Личное (вывод)',
    type: 'expense',
    direction: 'dividends',
  ...
  {
    id: CATEGORY_IDS.CLIENT_PAYMENT,
    name: 'Оплата клиента',
    type: 'income',
    direction: 'operational',
