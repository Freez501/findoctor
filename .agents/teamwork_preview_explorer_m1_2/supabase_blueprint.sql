...
-- ============================================================================
-- 3. TABLE: EVENTS (Мероприятия и банкеты)
-- ============================================================================
...
-- ============================================================================
-- 4. TABLE: CATEGORIES (Категории доходов и расходов)
-- ============================================================================
...
-- ============================================================================
-- 5. TABLE: TRANSACTIONS (Финансовые операции)
-- ============================================================================
...
COMMENT ON TABLE transactions IS 'Атомарные транзакции: приход, расход, перевод с гарантией балансовой целостности';
...
-- ============================================================================
-- 9. PRE-SEEDED DEMO DATA (5 Счетов, 12 Категорий, 2 Ивента, 21 Операция)
-- ============================================================================

-- 9.1 Accounts (Initial: 840 000 ₽, Final after 21 tx: 1 166 300 ₽)
INSERT INTO accounts (id, name, type, description, initial_balance, current_balance, currency, is_active, updated_at) VALUES
('cash_1', 'Нал 1 (Касса на площадке)', 'cash', 'Разменная касса барменов на площадке, чаевые, мелкие чеки (лёд, мята)', 25000.00, 6300.00, 'RUB', true, '2026-09-16T23:30:00Z'),
('cash_2', 'Нал 2 (Сейф / Владелец)', 'cash', 'Сейф в офисе: расчёты наличными, гонорары барменов, резерв наличных', 180000.00, 199000.00, 'RUB', true, '2026-09-16T23:30:00Z'),
('bank_1', 'Безнал 1 (Основной р/с)', 'bank', 'Расчётный счёт кейтеринга в банке (договоры с юрлицами, оптовые закупки алкоголя)', 450000.00, 814000.00, 'RUB', true, '2026-09-16T23:30:00Z'),
('bank_2', 'Безнал 2 (Резерв / Эквайринг)', 'bank', 'Торговый эквайринг на выезде (терминал на стойке) и резервный расчётный счёт', 120000.00, 112000.00, 'RUB', true, '2026-09-16T23:30:00Z'),
('card_sbp', 'Переводы (Карта СБП)', 'card', 'Личная карта шеф-бармена для мгновенных оплат по СБП и срочных оплат такси', 65000.00, 35000.00, 'RUB', true, '2026-09-16T23:30:00Z')
